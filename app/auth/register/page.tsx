    ...
    return (
        <RegistrationComponent>
            <div className="flex flex-col gap-1">
                        ...
                        <input type="text" name="namaLengkap" id="" className="rounded w-full border-[0.5px] border-gray-400 focus:outline-none px-2 py-1" />
                        
                        <label className="text-sm" htmlFor="namaBisnis">Nama Bisnis Anda</label>
                        <input type="text" name="namaBisnis" id="" className="rounded w-full border-[0.5px] border-gray-400 focus:outline-none px-2 py-1" />
                        ...
                        <input type="password" name="confirmPassword" id="" className="rounded w-full border-[0.5px] border-gray-400 focus:outline-none px-2 py-1" />
